...
# if os.path.exists(data_folder / data_file.replace(".csv", saving_file_suffix)):
#     raw_df_0_extended = pd.read_pickle(data_folder / data_file.replace(".csv", saving_file_suffix))
...
#     raw_df_0['reaction'] = rctn_list
#     raw_df_0['ligandID'] = lgid_list

#     raw_df_0_extended = copy.deepcopy(raw_df_0)
#     raw_df_0_extended.to_pickle(data_folder / data_file.replace(".csv", saving_file_suffix))
